...
enum struct OrderMicroTag : afterhours::TagId {
    ...
    Shipped_Stamp1 = 38,
    Shipped_Stamp2 = 39,
    Complete_CloseoutDelay = 40,
    Complete_ClosedOut = 41,
};
...
enum struct GameTag : afterhours::TagId {
    ...
    IsInProgressOrder =
        static_cast<afterhours::TagId>(GeneralTag::IsInProgressOrder),
    IsOnConveyor = static_cast<afterhours::TagId>(GeneralTag::IsOnConveyor),
    IsSelectedOrder =
        static_cast<afterhours::TagId>(GeneralTag::IsSelectedOrder),

    // Order macro tags
    OrderMacro_Incoming =
        static_cast<afterhours::TagId>(OrderMacroTag::Incoming),
    OrderMacro_Opened = static_cast<afterhours::TagId>(OrderMacroTag::Opened),
    OrderMacro_RequestingItems =
        static_cast<afterhours::TagId>(OrderMacroTag::RequestingItems),
    OrderMacro_ReceivingItems =
        static_cast<afterhours::TagId>(OrderMacroTag::ReceivingItems),
    OrderMacro_ReadyToBox =
        static_cast<afterhours::TagId>(OrderMacroTag::ReadyToBox),
    ...
    OrderMacro_Complete =
        static_cast<afterhours::TagId>(OrderMacroTag::Complete),

    // Order micro tags
    OrderState_Incoming_Arrived =
        static_cast<afterhours::TagId>(OrderMicroTag::Incoming_Arrived),
    OrderState_Incoming_Backlogged =
        static_cast<afterhours::TagId>(OrderMicroTag::Incoming_Backlogged),
    OrderState_Opened_Active =
        static_cast<afterhours::TagId>(OrderMicroTag::Opened_Active),
    OrderState_Opened_Inactive =
        static_cast<afterhours::TagId>(OrderMicroTag::Opened_Inactive),
    OrderState_Requesting_NeedsInput =
        static_cast<afterhours::TagId>(OrderMicroTag::Requesting_NeedsInput),
    OrderState_Requesting_InputError =
        static_cast<afterhours::TagId>(OrderMicroTag::Requesting_InputError),
    OrderState_Requesting_AllRequested =
        static_cast<afterhours::TagId>(OrderMicroTag::Requesting_AllRequested),
    OrderState_Receiving_OnConveyorWaiting = static_cast<afterhours::TagId>(
        OrderMicroTag::Receiving_OnConveyorWaiting),
    OrderState_Receiving_OnConveyorMoving = static_cast<afterhours::TagId>(
        OrderMicroTag::Receiving_OnConveyorMoving),
    OrderState_Receiving_ReceivedToReady = static_cast<afterhours::TagId>(
        OrderMicroTag::Receiving_ReceivedToReady),
    OrderState_ReadyToBox_Staged =
        static_cast<afterhours::TagId>(OrderMicroTag::ReadyToBox_Staged),
    OrderState_ReadyToBox_Queued =
        static_cast<afterhours::TagId>(OrderMicroTag::ReadyToBox_Queued),
    OrderState_Boxing_FoldBox =
        static_cast<afterhours::TagId>(OrderMicroTag::Boxing_FoldBox),
    OrderState_Boxing_PutItems =
        static_cast<afterhours::TagId>(OrderMicroTag::Boxing_PutItems),
    OrderState_Boxing_Fold =
        static_cast<afterhours::TagId>(OrderMicroTag::Boxing_Fold),
    OrderState_Boxing_Tape =
        static_cast<afterhours::TagId>(OrderMicroTag::Boxing_Tape),
    OrderState_Boxing_Ship =
        static_cast<afterhours::TagId>(OrderMicroTag::Boxing_Ship),
    OrderState_Shipped_Stamp0 =
        static_cast<afterhours::TagId>(OrderMicroTag::Shipped_Stamp0),
    OrderState_Shipped_Stamp1 =
        static_cast<afterhours::TagId>(OrderMicroTag::Shipped_Stamp1),
    OrderState_Shipped_Stamp2 =
        static_cast<afterhours::TagId>(OrderMicroTag::Shipped_Stamp2),
    OrderState_Complete_CloseoutDelay =
        static_cast<afterhours::TagId>(OrderMicroTag::Complete_CloseoutDelay),
    OrderState_Complete_ClosedOut =
        static_cast<afterhours::TagId>(OrderMicroTag::Complete_ClosedOut),
};
